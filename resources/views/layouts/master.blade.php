...
<head>
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/97951977" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
</head>
                        ...
                        <a href="/" class="logo">
                            @if (request()->is('/'))
                                <img src="/assets/img/logo-main.svg" alt="site logo" class="main-logo"
                                     style="width: 200px;">
                            @else
                                <img src="/assets/img/logo-main-light.svg" alt="site logo" class="main-logo"
                                     style="width: 200px;">
                            @endif
                    ...
                    <div class="menu-wrapper main-nav-container canvas-menu-wrapper" id="mega-menu-wrap">
                            ...
                            <li class="has-submenu menu-item-depth-0">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    @foreach($categories as $category)
                                        <li>
                                            <a href="{{route('portfolio.index', $category->id)}}">{{$category->name}}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </li>
                        ...
                        <div class="nav-right">
                            <a href="{{route('pricing.index')}}"
                               class="gp-btn color-eight btn-light btn-outline btn-round">
                                Цены
                            </a>
                        </div>
